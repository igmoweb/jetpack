		...
		<div class="footer">
			...
			<nav class="secondary nav-horizontal">
				<div class="secondary-footer">
					...
					<a href="http://edublogs.org/contact/" title="<?php esc_attr_e( 'Contact Edublogs.', 'jetpack' ); ?>"><?php _e( 'Support', 'jetpack' ); ?></a>
					<a href="http://edublogs.org/contact/" title="<?php esc_attr_e( 'Take a survey.  Tell us how we&#8217;re doing.', 'jetpack' ); ?>"><?php _e( 'Give Us Feedback', 'jetpack' ); ?></a>
